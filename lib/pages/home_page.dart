import 'package:airadio/modle/radio.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton("f7a784b5284577d18af9cf7963a1910c2e956eca572e1d8b807a3e2338fdd0dc/stage", buttonAlign: AlanVoice.BUTTON_ALIGN_RIGHT);
  ...
  static Future<Null> launchWhatsApp() async {
  ...
  static Future<Null> launchYoutube() async {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          [
            AppBar(
            title: "AI Radio".text.xl4.bold.white.make().shimmer(primaryColor: Vx.purple300, secondaryColor: Vx.white),
            elevation: 0.0,
              ...
              return VxBox(
                ...
                [
                  Positioned(
                    ...
                    ).height(40).black.alignCenter.withRounded(value: 8.0).make(),
                  ),
                  Align(
